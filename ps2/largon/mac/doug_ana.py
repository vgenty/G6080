...
infile = TFile("../output/out.root","READ")
...
VI = [1-1/(864*6*1.069)*k for k in VI]
...
names = ["Pot Energy","Total E","Virial"]
corrs = []
corr = 0.0
CORR = []
